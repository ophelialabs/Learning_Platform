        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Enrollments_UserId_CourseId", x => new { x.UserId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_UserAchievements_UserId_AchievementId", x => new { x.UserId, x.AchievementId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_LessonProgress_UserId_LessonId", x => new { x.UserId, x.LessonId });
                    table.ForeignKey(
